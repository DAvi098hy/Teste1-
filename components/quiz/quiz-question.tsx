              ...
              <div className="flex items-center">
                <div
                  className={`w-4 h-4 rounded-full border-2 mr-3 flex-shrink-0 ${
                    isSelected(option.value) ? "border-green-500 bg-green-500" : "border-gray-500"
                  }`}
                >
        ...
        <div className="flex justify-between items-center">
          ...
          <button
            ...
            className={`flex items-center px-6 py-3 rounded-lg font-medium transition-all ${
              canProceed ? "bg-green-600 hover:bg-green-700 text-white" : "bg-gray-700 text-gray-400 cursor-not-allowed"
            }`}
          >
            Próximo
