      ...
      <div className="w-full max-w-2xl px-4">
        <div className="text-center mb-8">
          <h1 className="text-2xl md:text-3xl font-bold mb-4">
            Analisando Seu Potencial de <span className="text-green-500">Testosterona</span>
          </h1>
          <p className="text-lg text-gray-300">Estamos criando seu protocolo de maximização...</p>
        </div>
        ...
        <div className="bg-gray-900 p-6 rounded-2xl border border-gray-800 shadow-xl">
            ...
            {steps.map((step, index) => (
              <motion.div
                ...
                className={`flex items-center p-3 rounded-lg transition-all duration-300 ${
                  index <= currentStep ? "bg-green-900/30 border border-green-500/30" : "bg-gray-800 border border-gray-700"
                }`}
          ...
          <div className="mt-6 text-center">
            ...
            <p className="text-gray-400 text-xs mt-2">
              Por favor, aguarde enquanto processamos seus dados para revelar seu nível máximo possível.
            </p>
          </div>
        </div>
      </div>
